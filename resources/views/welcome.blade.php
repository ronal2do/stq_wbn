...
<body id="page-top" class="index">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">Web<span style="color:#18bc9c;">i</span>nar</a>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        <span class="name">Web<span style="color:#2C3E50;">i</span>nar</span>
                        <hr class="star-light">
    ...
    <section class="success" id="about">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2>Sobre o Web<span style="color:#2C3E50;">i</span>nar</h2>
                    <hr class="star-light">
                </div>
            </div>
            <div class="row">
    ...
    <footer class="text-center">
        <div class="footer-above">
            <div class="container">
                <div class="row">
                    ...
                    <div class="footer-col col-md-4">
                        <h3>Sobre Web<span style="color:#18bc9c;">i</span>nar</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.<a href="http://startbootstrap.com">Start Bootstrap</a>.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        Copyright &copy; Web<span style="color:#18bc9c;">i</span>nar 2016
                    </div>
                </div>
            </div>
        </div>
